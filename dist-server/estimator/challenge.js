...
class Challenge {
  ...
  challengeTwo() {
    ...
    this.impact.hospitalBedsByRequestedTime = this.discardDecimal(Number(availableBeds - iSevCasesByT));
    this.severeImpact.hospitalBedsByRequestedTime = this.discardDecimal(Number(availableBeds - sISevCasesByT));
  }
